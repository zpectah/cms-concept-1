...
export const useSettingsQuery = () => {
  ...
  const settingsPatchMutation = useMutation<{ rows: number }, unknown, Partial<Settings>>({
  ...
  const settingsLocaleDefaultMutation = useMutation<{ rows: number; locale: string }, unknown, { locale: string }>({
  ...
  const settingsLocaleToggleMutation = useMutation<{ rows: number; locale: string }, unknown, { locale: string }>({
