...
require_once PATH_ROOT . 'router/Articles.php';
require_once PATH_ROOT . 'router/Attachments.php';
...
require_once PATH_ROOT . 'router/Messages.php';
require_once PATH_ROOT . 'router/Pages.php';
require_once PATH_ROOT . 'router/Requests.php';
